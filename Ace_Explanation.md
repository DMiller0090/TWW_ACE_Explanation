...
<br /><br />
This has been a massive community effort with much thanks to the following people for their contributions:
- Minimini352
- EJ125
- Azer67
- ShadowQCD
...
Images are s3tc compressed. These values more or less represent the brightness/darkness levels of that particular region in the image.<br />
...
6. We hold very precise inputs on controllers 2-4 to produce machine code which the game will execute.  
   - the controller data branches to useful in-game code whose exact details are somewhat involved, but ultimately the effect is that the payload essentially disables one line of code that prevents the credits from triggering whenever you load a new stage
